//
//  DynamicIsActivityLiveActivity.swift
//  DynamicIsActivity
//
...
struct DynamicIsActivityLiveActivity: Widget {
    var body: some WidgetConfiguration {
        ActivityConfiguration(for: DynamicIsActivityAttributes.self) { context in
...
//#Preview("Notification", as: .content, using: DynamicIsActivityAttributes.preview) {
//   DynamicIsActivityLiveActivity()
//} contentStates: {
//    DynamicIsActivityAttributes.ContentState.smiley
//    DynamicIsActivityAttributes.ContentState.starEyes
//}
